export { default as Login } from "./pages/login_page/LoginPage.jsx";
export { default as Register } from "./pages/registration_page/RegisterPage.jsx";
export { default as HomePage } from "../App.jsx";
